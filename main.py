#!/usr/bin/env python3
"""
AI CRM Bot - Главный файл с AI Context Parser
"""
...
from myparser.ai_context_parser import AIContextParser  # Исправленный импорт
...
class AIBot:
    ...
    def __init__(self):
        ...
        logger.info(f"    Мин. уверенность: {parsing_config.get('min_confidence_score', 70)}%")
        logger.info(f"    Окно контекста: {parsing_config.get('context_window_hours', 24)}ч")
        logger.info(f"    Мин. сообщений: {parsing_config.get('min_messages_for_analysis', 1)}")
